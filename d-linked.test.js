const LinkedList = require("./d-linked-list");
...
describe('read',function(){
    it('returns list in array format',()=>{
        let lst = new LinkedList([1,2,3,4,5,6,7,8]);
        expect(lst.read()).toEqual([1,2,3,4,5,6,7,8])
    })
})
describe('reverse',function(){
    it('reverses the order of a list',()=>{
        let lst = new LinkedList([1,2,3,4,5,6,7,8]);
        expect(lst.reverse())
        expect(lst.read()).toEqual([8,7,6,5,4,3,2,1])
    })
})
